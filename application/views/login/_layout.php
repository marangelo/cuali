...
<head>
    ...
    <!-- Jquery UI-->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/cl/vendors/jquery-ui/jquery-ui.min.css">
    <link rel="stylesheet" href="<?= base_url(); ?>assets/cl/vendors/jquery-ui/jquery-ui.theme.min.css">
    <!-- Bootstrap-->
    ...
    <!-- Responsive Tabs-->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/cl/vendors/responsive-tabs/css/responsive-tabs.css">
    <!-- Ladda Loader-->
...
<body class="app sidebar-mini">
    ...
    <!--JQuery UI-->
    <script src="<?= base_url(); ?>assets/cl/vendors/jquery-ui/jquery-ui.min.js"></script>
    <!--Popper-->
    ...
    <!--Side Reveal-->
    <script src="<?= base_url(); ?>assets/cl/vendors/slidereveal/jquery.slidereveal.min.js"></script>
    <!--Summernote-->
    ...
    <!--Responsive Tabs-->
    <script src="<?= base_url(); ?>assets/cl/vendors/responsive-tabs/js/jquery.responsiveTabs.min.js"></script>
    <!-- Jquery Validation-->
    ...
    <!-- Custom Js-->
    <script src="<?= base_url(); ?>assets/cl/js/admin/core.js"></script>
    <!-- Custom Js Based on Controller-->
    <script src="<?= base_url(); ?>assets/cl/js/admin/users.js"></script>
</body>
